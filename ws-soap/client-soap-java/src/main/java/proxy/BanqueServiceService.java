 ...
 * 
 */
@WebServiceClient(name = "BanqueServiceService", targetNamespace = "http://ws.enset.ma/", wsdlLocation = "http://localhost:7070/BanqueWS?wsdl")
    ...
    extends Service
{
    ...
    private static final QName BANQUESERVICESERVICE_QNAME = new QName("http://ws.enset.ma/", "BanqueServiceService");
    ...
    public BanqueWS getBanqueWSPort() {
        return super.getPort(new QName("http://ws.enset.ma/", "BanqueWSPort"), BanqueWS.class);
    }
    ...
    public BanqueWS getBanqueWSPort(WebServiceFeature... features) {
        return super.getPort(new QName("http://ws.enset.ma/", "BanqueWSPort"), BanqueWS.class, features);
    }
